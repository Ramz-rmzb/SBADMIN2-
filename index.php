...
shrink-to-fit=no">
    ...
    <title>RAMZABI PT.Sawit Ramz</title>
...
justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">RAMZABI</div>
            </a>
            <!-- Divider -->
                ...
                <div id="collapseTwo" class="collapse"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item"
                            href="?page=mahasiswa">Supliyer</a>
                        <a class="collapse-item"
                            href="?page=pengumuman">Pengumuman</a>
                        <a class="collapse-item"
                            href="?page=info">Info</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
...
text-gray-600 small">RAMZABI</span>
                                <img class="img-profile rounded-circle"
                                    src="http://localhost/ramzabi/SBADMIN2/img/RAMZABI.jpeg">
                            </a>
...
justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dashboard Ramzabi</h1>
...
font-weight-bold text-primary text-uppercase mb-1">
                                                    ...
                                                    (Monthly)</div>
                                                <div class="h5 mb-0
font-weight-bold text-gray-800">Rp.100,000,000,000</div>
                                            </div>
                                            <div class="col-auto">
...
font-weight-bold text-success text-uppercase mb-1">
                                                    ...
                                                    (Monthly)</div>
                                                <div class="h5 mb-0
font-weight-bold text-gray-800">Rp.99,999,999,999</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas
...
align-items-center">
                                                    <div class="col-auto">
                                                        <div class="h5
mb-0 mr-3 font-weight-bold text-gray-800">90%</div>
                                                    </div>
                                                    <div class="col">
                                                        <div
...
dropdown-menu-right shadow animated--fade-in"
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <img src="http://localhost/ramzabi/SBADMIN2/img/RAMZABI.jpeg">
                                </div>
                            </div>
                        </div>
                    </div>
